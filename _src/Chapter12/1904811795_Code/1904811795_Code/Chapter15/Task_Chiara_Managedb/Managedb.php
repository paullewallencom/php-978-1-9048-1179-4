...
class PEAR_Task_Chiara_Managedb extends PEAR_Task_Common
{
    ...
    function serializeDSN($dsns, $channel = null)
    {
        ...
        foreach ($dsns as $i => $dsn) {
            $dsn = str_replace($this->_config->get('chiaramdb2schema_driver', null, $channel)
                . '://', '', $dsn);
        ...
        $this->config->set('chiaramdb2schema_dsn', $finaldsn, $channel);
        $this->config->set('chiaramdb2schema_password', $finalpassword, $channel);
    }
